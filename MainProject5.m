%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Investigates evolution in a disordered lattice
...
%%%%%%%%%%%%%%%%%%
N=1;        % Number of atoms
M=20;        % Number of wells/modes - fixed to 2
%E = zeros(M,1);   % Energy of well set to zero
E=rand(M,1)*2;      % could look at random well depths to see if this has a difference 
